// returnFirstTwoDrivers() — Declare a variable with const that is assigned an anonymous
...
// function that will multiply a fare for a ride accordingly. If createFareMultiplier() receives an argument of 4, it
// will return a function that takes in a fare as an argument and quadruples the fare.
...
// createFareMultiplier() in such a way that the new fareDoubler() function accepts a fare as its lone argument and
// doubles it.

const fareDoubler = createFareMultiplier(2);

// fareTripler() — Declare a variable with const and assign a function returned by createFareMultiplier() to it. Invoke
// createFareMultiplier() in such a way that the new fareTripler() function accepts a fare as its lone argument and
// triples it.
...
const selectDifferentDrivers = function (arrayDrivers, pickedDrivers) {
  return pickedDrivers(arrayDrivers)
};
